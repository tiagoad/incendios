...
concelhos = {  # Lisboa
               ...
               'Vila Franca de Xira': (155, 409),  # Leiria
               'Peniche': (129, 358),
               'Bombarral': (143, 365),
               'Óbidos': (137, 355),
               ...
               'Pedrógão Grande': (230, 291),  #Coimbra
               'Arganil': (250, 256),
               'Cantanhede': (190, 241),
               'Coimbra': (207, 257),
               ...
               'Soure': (188, 272),
               'Tábua': (243, 245),
               'Vila Nova de Poiares': (224, 257),  #Aveiro
               'Águeda': (211, 215),
               ...
               'Vila Nova de Gaia': (194, 156),  # Braga
               'Amares': (215, 91),
               'Barcelos': (189, 102),
               'Braga': (208, 103),
               ...
               'Vila Verde': (204, 88),
               'Vizela': (221, 124),  #Viana do Castelo
               ...
               'Vila Nova de Cerveira': (185, 59),  #Setúbal
               'Alcochete': (167, 431),
               ...
               'Vila Real de Santo António': (288, 603),  #Santarém
               'Abrantes': (230, 349),
               'Alcanena': (186, 345),
               'Almeirim': (188, 377),
               'Alpiarça': (194, 371),
               ...
               'Vila Nova da Barquinha': (208, 342),  #Bragança
               ...
               'Seia': (272, 236),
               'Trancoso': (305, 188),
               'Vila Nova de Foz Côa': (320, 159),  #Viseu
               'Armamar': (274, 153),
               ...
               'Viseu': (254, 202),
               'Vouzela': (236, 204),  #Castelo Branco
               'Belmonte': (305, 243),
...
for concelho, posicao in concelhos.items():
    hazard[concelho] = get_level(posicao[0], posicao[1])
